  ...
  return (
    ...
    <div className='text-black flex items-center justify-center p-20'>
      <div className='w-1/2 items-center justify-center flex'>
        <img src="public/images/pdp.png" alt="" className=' bg-gray-300 rounded-full w-2/3'/>
      </div>
      <div className='w-1/2 text-justify p-20'>
        <div>
          ...
          <p>Je maîtrise plusieurs langages de programmation, dont <span>HTML</span>, <span >CSS</span>, <span>JavaScript</span> et <span>PHP</span>.</p>
